...
# Platform services: api-gateway, worker, redis, qdrant.
# User step services are written to docker-compose.override.yml by `moira pipeline dev`.
...
services:
  ...
  worker:
    ...
    volumes:
      - ./.moiraweave/pipelines:/workspace/pipelines:ro
