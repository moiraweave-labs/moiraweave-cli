...
def ensure_local_env(repo_root: Path) -> None:
    ...
    content = (
        ...
        "# Empty by default so local onboarding does not download embedding models.\n"
        "# Set to BAAI/bge-small-en-v1.5 or another FastEmbed model to enable semantic search.\n"
        "EMBEDDING_MODEL=\n"
